...
const IntroductionsTestOne = () => {
  return (
    <ul className="list-disc">
      ...
      <li>
        Aşağıdaki kartla eşleşen dört karttan birine tıklayın. Seçiminizi takip
        edin, geri bildirim alacaksınız. Eşleştirmeniz doğru değilse, farklı bir
        kural denemeniz gerekir.
      </li>
      <li>
      ...
      <li>
        ...
        bildirimleri dikkatle izlemeniz gerekir. Eğer hata mesajları veriyorsa,
        kuralınızı değiştirmeniz gerekir!
      </li>
    </ul>
  );
};
